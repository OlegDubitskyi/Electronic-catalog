								...
								<td>
									<table border="0" width="100%" cellpadding="0" cellspacing="0">
										<tr>
											...
											{if $reg_confirmed==1}	
												Ваша регистрация подтверждена, для добавления в каталог Вашего магазина<br>
												разместите пожалуйста на своем сайте нашу кнопку:<br><br>
												<a href="http://www.webcat.com.ua" target="new"><img src="img/blue88x31.gif" width=88 height=31 alt="WebCatalog" border=0></a><br><br>
												{$button_code}<br><br>
											{elseif $reg_confirmed==2}
												Ваш регистрация уже была подтверждена!
											{else}
												Ваша регистрация не может быть подтверждена,<br>
												для выяснения причины обратитесь в службу поддержки <a href="mailto:support@webcat.com.ua">support@webcat.com.ua</a>
											{/if}
											</td>
										</tr>
									</table>		
