...
<!---Навигация и фильтры --->
			{include file="filters/all_filters_for_search.tpl"}
<!---/Навигация и фильтры --->		
		</td>
	</tr>
	<tr>
					...
					<td>
						<table class="rows" width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr {if $smarty.foreach.positions.index%2==0}class=m{/if}>
								...
								<td align="center">{if $p.price_ua!=0}{$p.price_ua}{else}-{/if}</td>
								<td align="center">{if $p.price_usd!=0}{$p.price_usd}{else}-{/if}</td>
