<?php /* Smarty version 2.6.12, created on 2006-12-22 08:36:27
									...
									<tr>
										...
										<td>
											<table class="t1" border="0" cellpadding="0" cellspacing="0">
												...
												<tr>
													<td width="15"></td>
													<td><a href="company_account.php?cmd=seller_price&cat_id=<?php echo $this->_tpl_vars['cat_data']['cat_id']; ?>
">Вернуться в категорию "<b><?php echo $this->_tpl_vars['cat_data']['cat_name']; ?>
</b>"</a></td>
												</tr>																			
