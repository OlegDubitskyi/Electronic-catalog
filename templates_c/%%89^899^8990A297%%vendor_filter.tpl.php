<?php /* Smarty version 2.6.12, created on 2006-12-20 18:13:06
         compiled from filters/vendor_filter.tpl */ ?>
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="page_bar">
			<?php if ($this->_tpl_vars['vendor_id'] == -1 || ! $this->_tpl_vars['vendor_id']): ?><b>Все</b> <?php else: ?><a href="index.php?cmd=open_c&cat_id=<?php echo $this->_tpl_vars['cat_id']; ?>
...
)</span><?php else: ?><a href="index.php?cmd=open_c&vid=<?php echo $this->_tpl_vars['v']['id']; ?>
