<?php /* Smarty version 2.6.12, created on 2007-02-18 13:29:37
         compiled from board/inc/right_block.tpl */ ?>
...
<!--/Обрамляющая полоска-->
	<?php if (! $this->_tpl_vars['buser_is_logged']): ?>
	<tr>
		<td bgcolor="#E8E7E3" width=5><img src="img/gray2.gif"></td>		
			...
			<table width="100%" border=0 cellpadding="0" cellspacing="0">
				<tr>
					<td height="20" align="center" bgcolor="#E8E7E3">
						Пользователь: <?php echo $this->_tpl_vars['login']; ?>
