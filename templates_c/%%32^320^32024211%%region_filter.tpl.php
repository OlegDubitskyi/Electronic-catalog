<?php /* Smarty version 2.6.12, created on 2006-12-20 11:22:29
         compiled from filters/region_filter.tpl */ ?>
<td class=filter>
	...
	<tr>
		...
		<td class="page_bar">
			<?php if ($this->_tpl_vars['selected_reg_id'] == -1 || ! $this->_tpl_vars['selected_reg_id']): ?>
				<b>Все</b>
			<?php else: ?><a href="index.php?cmd=open_c&vid=<?php echo $this->_tpl_vars['vendor_id']; ?>
...
</b><?php else: ?><a href="index.php?cmd=open_c&vid=<?php echo $this->_tpl_vars['vendor_id']; ?>
&cat_id=<?php echo $this->_tpl_vars['cat_id']; ?>
&rid=<?php echo $this->_tpl_vars['rl']['id']; ?>
"><?php echo $this->_tpl_vars['rl']['region_name']; ?>
</a><?php endif;  else:  if ($this->_tpl_vars['selected_reg_id'] == $this->_tpl_vars['rl']['id']): ?>, <?php echo $this->_tpl_vars['rl']['region_name'];  else: ?>, <a href="index.php?cmd=open_c&vid=<?php echo $this->_tpl_vars['vendor_id']; ?>
&cat_id=<?php echo $this->_tpl_vars['cat_id']; ?>
&rid=<?php echo $this->_tpl_vars['rl']['id']; ?>
"><?php echo $this->_tpl_vars['rl']['region_name']; ?>
