<?php /* Smarty version 2.6.12, created on 2007-01-25 21:45:10
         compiled from board/register.tpl */ ?>
<?php echo '
										...
										<tr>
											<td style="BORDER-TOP: #C4C4C4 1px solid; FONT-SIZE:12px; PADDING-TOP:10px;" align="center">
												...
												<table class="import" border="0" cellpadding=2>
													...
													<tr>
														<td colspan="2" style="font-color:#ff0000">Такой email уже существует в базе</td>
													</tr>
													<?php elseif ($this->_tpl_vars['login_error'] && ! $this->_tpl_vars['email_error']): ?>
													<tr>
														<td colspan="2" style="font-color:#ff0000">Такой логин уже существует в базе</td>
													</tr>
													<?php elseif ($this->_tpl_vars['login_error'] && $this->_tpl_vars['email_error']): ?>													
													<tr>
														<td colspan="2" style="font-color:#ff0000">Такой логин и email уже существует в базе</td>
													</tr>													
													<?php endif; ?>
...
?>
													<tr>
														...
														<td><input type="text" name="user_data[login]" value="<?php echo $this->_tpl_vars['u']['login']; ?>
" size="20"></td>
													</tr>
													<tr>
...
" ><?php echo $this->_tpl_vars['rl']['region_name']; ?>
													...
													<tr>
														<td colspan="2" align="center"><input type="button" value="Регистрировать" onclick="SubPage()"></td>
													</tr>
												</table>
												</form>
											</td>
