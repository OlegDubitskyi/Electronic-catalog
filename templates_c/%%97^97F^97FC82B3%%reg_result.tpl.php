										...
										<tr>
											<td style="BORDER-TOP: #C4C4C4 1px solid; FONT-SIZE:12px; PADDING-TOP:10px;" align="center">
												...
												<table class="import" border="0" cellpadding=2>
													<tr>
														<td>Пользователь <b><?php echo $this->_tpl_vars['login']; ?>
</b> был успешно зарегистрирован</td>
													</tr>
													<tr>
														<td>На почтовый ящик <b><?php echo $this->_tpl_vars['email']; ?>
</b> было выслано письмо с логином и паролем</td>
													</tr>													
												</table>
												</form>
											</td>
