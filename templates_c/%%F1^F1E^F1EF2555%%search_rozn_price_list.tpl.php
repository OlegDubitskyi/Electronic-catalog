<?php /* Smarty version 2.6.12, created on 2007-02-28 22:46:48
         compiled from search_rozn_price_list.tpl */ ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "filters/all_filters_for_search.tpl", 'smarty_include_vars' => array()));
...
" target="new"><?php echo $this->_tpl_vars['p']['vendor_name']; ?>
 ...
 <?php echo $this->_tpl_vars['p']['description']; ?>
								...
								<td align="center"><?php if ($this->_tpl_vars['p']['price_ua'] != 0):  echo $this->_tpl_vars['p']['price_ua'];  else: ?>-<?php endif; ?></td>
								<td align="center"><?php if ($this->_tpl_vars['p']['price_usd'] != 0):  echo $this->_tpl_vars['p']['price_usd'];  else: ?>-<?php endif; ?></td>
...
" title="подробнее" target="new"><?php echo $this->_tpl_vars['p']['company_name']; ?>
</a><br>
